...
public class ChargerEnemy extends Enemy {
    ...
    public ChargerEnemy(double x, double y, int width, int height, double statsMultiplier){
        super(x, y, width, height,(int) (statsMultiplier*(ChargerEnemyStats.baseHP)),(int) (statsMultiplier*ChargerEnemyStats.baseAttack), 30,Math.min((int) (statsMultiplier+Math.round(ChargerEnemyStats.baseSpeed+Math.random())),ChargerEnemyStats.max_speed));
        setStunCoolDown(20);
        setWeight(5);
    }

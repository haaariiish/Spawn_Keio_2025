...
public class Frame1 extends JFrame{
    ...
    public Frame1(String title){
        ...
        JButton new_game = new JButton("Commencez une nouvelle partie"); // bouton de nouvelle partie
        ...
        JMenuItem menuItem = new JMenuItem("Nouvelle partie",KeyEvent.VK_1);
        menu.add(menuItem);

        // changer des paramètres comme la musique ou la couleur des pions  
        JMenuItem menuItem2 = new JMenuItem("Revenir sur l'écran d'accueil",KeyEvent.VK_3);
        menu.add(menuItem2);
        // menuItem2.addActionListener(new QuitGame(this));

        // Bouton supplémentaire pour quitter le jeu
        JMenuItem menuItem3 = new JMenuItem("Quitter",KeyEvent.VK_4);
        menu.add(menuItem3);
